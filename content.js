...
chrome.runtime.onMessage.addListener(function(message, sender, sendResponse) {
    ...
    const options = [
        'Select a suggested query from the list',
        `What interesting entries are in the deployment logs for the "${message.project}" project in the "Production" environment?`,
        `What are the URLs contained in the deployment logs for the "${message.project}" project in the "Production" environment?`,
        `What is the release version and state for the latest deployment of the "${message.project}" project in the "Production" environment? Display the answer in a markdown table.`,
        `What is the release version and state for the previous deployment of the "${message.project}" project in the "Production" environment? Display the answer in a markdown table.`,
        ...
        `What are the steps in the "${message.project}" project with a step type of "Octopus.Manual"? If you can not find any matching steps, say so in the answer. Show the step name and type in a markdown table.`,
        ...
        `What are the unique environment names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique tenant names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique feed names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique account names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique library variable set names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique worker pool names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique machine names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique certificate names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique tag set names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique lifecycle names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique git credential names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
        `What are the unique machine policy names in the space, sorted in alphabetical order? Display the answer in a markdown table.`,
    ]
    for (let i = 0; i < options.length; i++) {
        const option = document.createElement('option');
        option.setAttribute('value', options[i]);
